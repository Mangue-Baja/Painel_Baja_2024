...
//Defines
  // Quando escrito "pin x", x representa o pino no datasheet.
  ...
  #define battery_led 26          // led de aviso de pouca bateria

 //botões e chaves para interações com o usuario
  #define BOTAO 23                //verde
  #define CHAVE 35               //roxo
  #define POTENCIOMETRO 34       //cinza

  #define Alerta_TempCVT 90       //temperatura estimada de quando a correia da cvt pode dar problema sem ter feito nenhum estudo sobre
